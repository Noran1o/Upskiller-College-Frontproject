document.addEventListener('DOMContentLoaded', () => {
  ...
  // عناصر الـ Modal والنموذج
  const signupModal = document.getElementById("signupModal");
  const closeSignup = document.getElementById("closeSignup");
  const signupForm = document.getElementById("signupForm"); 

  // 🌟 العناصر الجديدة لـ Title و Submit Button 🌟
  const modalTitle = document.getElementById("modalTitle"); 
  const modalSubmitBtn = document.getElementById("modalSubmitBtn");
  
  // ==========================================================
  // 2. وظيفة إظهار النافذة وتخصيص محتواها
  // ==========================================================
  function openAuthModal(isLogin) {
    ...
    if (isLogin) {
      ...
      // في وضعية Login، نخفي حقل الاسم ونجعله غير مطلوب
      ...
      // في وضعية Sign Up، نظهر حقل الاسم ونجعله مطلوب
  ...
  // ==========================================================
  // 3. وظيفة تبديل حالة المستخدم (Login/Logout)
  // ==========================================================
  ...
  // ربط زر Login لاستدعاء openAuthModal بـ (true)
  if (openLogin && signupModal) {
    openLogin.addEventListener('click', () => openAuthModal(true)); 
  }
  
  // ربط زر Sign Up لاستدعاء openAuthModal بـ (false)
  ...
  // معالج إرسال النموذج (Validation & التسجيل)
  if (signupForm) {
    signupForm.addEventListener('submit', (e) => {
      ...
      let userName = 'User';
      if (!isLoginProcess) {
         // إذا كانت عملية Sign Up، نأخذ الاسم
        ...
        // إذا كانت عملية Login
        // هنا يمكنك التحقق من صحة البريد وكلمة المرور فقط
